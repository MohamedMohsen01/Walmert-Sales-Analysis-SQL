...
-- What are the less selling product lines?
SELECT
	product_line,
	SUM(quantity) as qty
FROM sales
...
-- Let's Fetch each product line and add a column to those product lines showing "Good", "Bad". Good if its greater than average sales.
